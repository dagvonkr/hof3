...
adminRoutes.route('/posts/edit/:postId', {
  ...
  , action: (params, queryParams) => {
    BlazeLayout.render('innerAdminLayout', {content: 'postEditor'});
  }
});
...
adminRoutes.route('/posts/:postId', {
  name: 'post'
  , action: (params, queryParams) => {
    BlazeLayout.render('innerAdminLayout', {content: 'post'});
  }
});
...
FlowRouter.notFound = {
 action: (params, queryParams) => {
   ...
   console.warn('Route not found: ', params, queryParams);
...
publicRoutes.route('/posts/:postId', {
  action: (params, queryParams) => {
    BlazeLayout.render('innerBlogLayout', {
      content: 'postView'
    });
  }
});
